...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/lukasautohandel.local/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/lukasautohandel.local/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/lukasautohandel.local/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/lukasautohandel.local/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/lukasautohandel.local/apps/frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'thomascloudofficial.com',
      'port' => 465,
      'encryption' => NULL,
      'username' => 'www@thomascloudofficial.com',
